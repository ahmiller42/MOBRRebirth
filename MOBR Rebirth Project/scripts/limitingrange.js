...
var World = {
    ...
    markerDrawable_yellow: null,
    markerDrawable_black: null,
    markerDrawable_red: null,
    ...
    onMarkerSelected: function(marker) {
        ...
        $("#poi-detail-obrtype").html(marker.poiData.obrtype);
    ...
    // getIcon: function (obrtype) {
    //     switch (obrtype) {
    //         case 'Crack': 
    //             return World.markerDrawable_yellow;
    //             break;
    //         case 'Leak':
    //             return World.markerDrawable_red;
    //             break;
    //         case 'Corrosion':
    //             return World.markerDrawable_black;
    //             break;
    //         default:
    //             return World.markerDrawable_black;
    //     };
